    ...
    <div class="container">
        <div class="row">
        	<div class="col-xl-4 col-lg-4  col-md-5">
                <div class="set-part-2">
                    <div class="blog-search1">
                        <form action="{{url('/sub_search_product_ck')}}/{{$id}}" method="GET">
                            <input type="text" placeholder="Search..." name="search" value="" id="search">
                            <input type="hidden" name="id" value="{{$id}}" id="sub_category_id">
                            <button type="submit">
            ...
            <div class="col-xl-8 col-lg-8 col-md-7" id="table_data">
                ...
                <div class="msg-error text-danger">We Will Add Product Soon !!</div>
...
;
...

         {
          ...
          $.ajax({
           url:"/sub_search_product/" + id +"?page="+page,
           method: 'GET',
