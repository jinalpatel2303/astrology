...
<div class="in-course">
	<div class="container">
		@foreach($courser_about_description as $cad)
		<div class="background-overlay" style="background-image :url('/uploads/{{$cad->bg_image}}');"></div>
		<div class="row">
			<div class="col-lg-6 col-md-6 order">
				<div class="course-details">
					...
					<div class="course-type">
						@foreach($courser_about as $key=>$ca)
						<div class="type">
							<span>{{$key+1}}</span>
							<p>{{$ca->title}}</p>
						</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="courses-img">
					<div class="co-images">
						<img src="image/window-23.png">
					</div>
					<div class="co-img">
						<img src="/uploads/{{$cad->image}}">
					</div>
				</div>
			</div>
		</div>
...
<div class="in-co-details">
	<div class="container">
		<div class="background-overlay1" style="background-image :url('/uploads/{{$detail_bg_image}}');"></div>
		<div class="c_back">
			<img src="image/astrology-bg2.png">
		</div>
		<div class="co-details">
			<div class="co-details-img">
				<img src="/uploads/{{$detail_image}}">
			</div>
			<div class="courses-contain">
				@foreach($courser_detail as $cd)
				<div class="question">
                    <h3>{{$cd->title}}</h3>
