	    			...
	    			<div class="col-lg-4">
	    				<div class="arrival-1">
                		    ...
                		    <div class="product-info">
                		    	...
                		    	<h6><i class="fa-solid fa-indian-rupee-sign"></i> {{$p->price}}<!--<del>$80</del>--><!--<span class="al-orange">(37.5% Off)</span>--></h6>
                		    ...
                		    <div class="buttons">
                                ...
                                @else
                                 <a href="add-cart.html" class="tooltip tooltip--left" data-tooltip="Go to cart"><i class="fa-solid fa-cart-plus"></i></a>
