...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href="index.html"><span>Header Offer</span></a>
            </li>
         </ul>
      </div>
            ...
            <table class="table table-bordered table-striped text">
            	...
            	@foreach($header_offer as $id)
                 ...
                 <tr>
                 	...
                 	<th class="text">{{$id->offer}}</th>

                 </tr>

                  <tr>

                  	 <th><button class="clo btn0"><a href="{{url('admin/add_header_offer_data')}}/{{$id->id}}">update</a></button></th>  
