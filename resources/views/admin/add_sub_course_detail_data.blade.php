...
<style type="text/css">
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Course Detail</span></a>
               @else
               <a href=""><span>Update Course Detail</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
          ...
          @else
            <h4 class="mb-4">Update Course Detail</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_sub_course_detail_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
