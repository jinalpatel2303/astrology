                 ...
                 <tbody class="case_studies_{{$ad->id}}">
                    <tr>
                       ...
                       <td>{{$ad->description}}</td>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_blog_detail_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                           <a class="icon__2" onclick="delete_cs_banner_list({{$ad->id}})"><i class="fas fa-trash-alt"></i></a>

                        </td>
                        <td class="clo">
                           <button class="clo btn0"><a href="{{url('/admin/view_blog_detail')}}/{{$ad->id}}">view</a></button>
                        </td>
                        ...
                        var BASE_URL = "{{ url('/') }}";
                            ...
                            var id = $id;
                             ...
                             $.ajax({
                                   ...
                                   url:BASE_URL+'/admin/delete_blog_detail/'+id,
                                   type:'GET',
                                   dataType: "json",
