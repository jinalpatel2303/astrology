...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href="index.html"><span>About Detail</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">About Occult Detail</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
            	...
            	@foreach($aboutus_occult as $id)
                  ...
                  <tr>
                     <th class="text bg-dark">{!!$id->description!!}</th>
                  </tr>
                  

                  <tr>
               	   <th><button class="clo btn0"><a href="{{url('admin/add_aboutus_occult_data')}}/{{$id->id}}">update</a></button></th>  
                  </tr>
