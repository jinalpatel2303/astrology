...
@section('content')
 ...
 <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         ...
         <form action="{{url('admin/store_update_notes')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
                        ...
                        <select name="course" id="course" >
                           <option value="">Select Course</option>
                             ...
                             @foreach($course_list as $c)
                              ...
                              <option value="{{ $c->id }}"{{$c->id== $course ? 'selected' : ''}}>{{ $c->name}}</option>
               ...
               <div class="details_inner">
                  <div class="part">
                     <div class="row">
                        ...
                        <div class="col-lg-10 data">
                           <input type="text" placeholder="Enter title" name="title" value="{{$notes_title}}" >
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6 data">
                            ...
                            <input type="file" name="file" onchange="readURL(this);" >
                               <input  type="hidden" name="oldfile" value="{{$file}}" readonly>


                            @if($extension=='pdf')
                            <input class="oldfile" type="text"  value="{{$file}}" readonly>
                            @else
