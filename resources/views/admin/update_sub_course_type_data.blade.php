 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               ...
               <a href=""><span>Update Courses About</span></a>
      ...
      <div class="page mt-4 hosting-page name1 page-with" style="display: block;">
         <div class="list1">
            ...
            <h4 class="mb-4">Update Courses About</h4>
           
         </div>
         <form action="{{url('admin/store_update_sub_course_type_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
               ...
               <div class="details_inner">
                  <div class="part">
                     <div class="row">
                        ...
                        <div class="col-lg-10 data">
                           <input type="text" placeholder="Enter Time Period" name="time_period" value="{{$time_period}}" >
