...
<style type="text/css">
  ...
  <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Courser Type</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <!-- <button class="btn1"><a href="{{url('admin/add_sub_course_type_data')}}" style="color:white;">ADD</a></button> -->
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
      ...
      <button class="clo btn0 button-new"><a href="{{url('/admin/home')}}">Back to Details</a></button>
      </div>
