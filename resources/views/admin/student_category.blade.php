      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
             ...
             @foreach($student_category as $sc)
                <h4 class="mb-0">{{$sc->fname}} {{$sc->lname}} Course Information</h4>
                 @break
               @endforeach
            ...
            <div class="btn1-main">
               ...
               <button class="btn1 past"><a href="{{url('admin/add_new_category')}}/{{$student_id}}" style="color:white">Add new category+</a></button>
               <button class="btn1 active"><a href="{{url('admin/assign_new_course')}}/{{$student_id}}" style="color:white">Assign new course+</a></button>
         ...
         <div class="pro-table table-responsive" id="table_data">
              ...
              @include('admin.search_student_category')
...
;
...

         {
          ...
          $.ajax({
           url:"/admin/search_past_student?page="+page,
           method: 'GET',
...
$(document) .on('keyup',function(e){
    e.preventDefault();
     let search_string = $("#search").val();
     $.ajax({
         url:"{{url('/admin/search_past_student')}}",
         method: 'GET',
        data:{search_string:search_string},
        success:function(res){
