      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($aboutus_about_description as $id)
                ...
                <tr>
                  ...
                  <tr>
                     <th><button class="clo btn0"><a href="{{url('admin/update_aboutus_about_description_data')}}/{{$id->id}}">update</a></button></th>
                  </tr>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <!-- <button class="btn1"><a href="{{url('admin/add_aboutus_about_data')}}/0" style="color:white;">ADD</a></button> -->
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($aboutus_about as $key=>$ad)
                 <tbody class="case_studies_{{$ad->id}}">
                    <tr>
                       ...
                       <td>{{$ad->count_name}}</td>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_aboutus_about_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
