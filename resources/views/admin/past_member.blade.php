...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Past Member Data</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Past Member Data</h4>

            
            <div class="btn1-main">

               <button class="btn1 past"><a href="{{url('admin/active_membar')}}" style="color:white">Active Member</a></button>
               ...
               <button class="btn1 delete">checked delete</button>
                <button class="btn1 export"><a href="{{ url('admin/Exportpastmember') }}" style="color:white;">Export to excel</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive" id="table_data">
            ...
            @include('admin.past_member_search')
