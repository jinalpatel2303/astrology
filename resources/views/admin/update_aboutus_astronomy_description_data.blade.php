 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               ...
               <a href=""><span>Update Astronomy Description</span></a>
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            ...
            <h4 class="mb-4">Update Astronomy Description</h4>
            
         </div>
         <form action="{{url('admin/store_update_aboutus_astronomy_description_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
