            ...
            <div class="col-xl-8 col-lg-7 col-md-7">
                <div class="single-blog">
                    ...
                    <ul class="blog-date">
                        ...
                        <li class="com1"><i class="far fa-comments"></i><span>20 comments</span></li>
                    </ul>
                    <div class="img_ single-img">
                        <img src="/uploads/{{$bd->inner_image}}">
                    </div>
                    {{$bd->description}}
                    <br><br>
                    {!!$bd->detail_description!!}
                </div>
            </div>
            @endforeach
        </div>
