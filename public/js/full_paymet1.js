                             ...
                             var options = {
                                                ...
                                                "handler": function (response){
                                                     ...
                                                     $.ajax({
                                                                ...
                                                                url: '/pay_amount',
                                                                type:'post',
                                                                data:{_token:_token,email:data.email,payment_id:response.razorpay_payment_id, student_payment_id:data.student_payment_id,student_rid:data.student_rid, selected_course:data.selected_course},
                                                                         ...
                                                                         var id = response.student_rid;
                                                                           ...
                                                                           $.ajax({
                                                                                     ...
                                                                                     success: function(response){                                                                
                                                                                         ...
                                                                                         window.location=BASE_URL+'/payment_success'
